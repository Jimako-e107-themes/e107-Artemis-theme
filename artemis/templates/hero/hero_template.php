...
$HERO_TEMPLATE['default']['start'] 	    = '<div class="carousel-item item bg-gradient-info  {HERO_SLIDE_ACTIVE}" >
						                  <div class="container">
						                  
						                  <div class="carousel-caption">
						                    <div class="hero-text-container">
						                      <header  class="hero-title animated slideInLeft animation-delay-5 page-header  bg-gradient-dark">
						                        <h1 class="animated fadeInLeft animation-delay-10 font-smoothing text-info">{HERO_TITLE: enwrap=strong}</h1>
