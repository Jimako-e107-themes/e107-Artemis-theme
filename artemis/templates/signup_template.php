...
$SIGNUP_WRAPPER['SIGNUP_DISPLAYNAME'] = 		"<div class='mb-3'>
...
$SIGNUP_WRAPPER['SIGNUP_REALNAME'] = 			"<div class='mb-3'>
...
$SIGNUP_WRAPPER['SIGNUP_SIGNATURE'] = 			"<div class='mb-3'>
...
$SIGNUP_WRAPPER['SIGNUP_USERCLASS_SUBSCRIBE'] = "<div class='form-group m-2 '>
...
$SIGNUP_TEMPLATE['body'] = "
	...
	<div id='default'>
		{SIGNUP_XUP_ACTION}
			...
			{SIGNUP_GDPR_INFO}
			<div class='m-2'>
				{SIGNUP_BUTTON: class=btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0}
			</div>	 
	</div>
	{SIGNUP_FORM_CLOSE}";
