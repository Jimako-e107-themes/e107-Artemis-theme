...
$NEXTPREV_TEMPLATE['bootstrap_start']			= '<div class="row text-center py-2"><div class="col-12 mx-auto">
<ul class="pagination pagination-primary m-4 justify-content-center">';
$NEXTPREV_TEMPLATE['bootstrap_end'] 			= '</ul></div></div>';
$NEXTPREV_TEMPLATE['bootstrap_nav_caption'] 	= '';

$NEXTPREV_TEMPLATE['bootstrap_nav_first'] 		= '<li class="page-item"><a class="page-link first hidden-xs" href="{url}" title="{url_label}" aria-label="{label}"><span aria-hidden="true"><i class="fa fa-angle-double-left" aria-hidden="true"></i></span></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] 		= '<li class="page-item"><a class="page-link prev" href="{url}" title="{url_label}" aria-label="{label}"><span aria-hidden="true"><i class="fa fa-angle-left" aria-hidden="true"></i></span></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] 		= '<li class="page-item"><a class="page-link last hidden-xs" href="{url}" title="{url_label}" aria-label="{label}"><span aria-hidden="true"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] 		= '<li class="page-item"><a class="page-link next" href="{url}" title="{url_label}" aria-label="{label}"><i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>';

$NEXTPREV_TEMPLATE['bootstrap_items_start'] 	= '';
$NEXTPREV_TEMPLATE['bootstrap_item'] 			= '<li class="page-item"><a class="page-link" href="{url}" title="{url_label}">{label}</a></li>';
$NEXTPREV_TEMPLATE['bootstrap_item_current'] 	= '<li class="page-item active"><a class="page-link" href="#" onclick="return false;" title="{url_label}">{label}</a></li>';
